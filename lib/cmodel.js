...
CModel.prototype.findAsync = function(query) {
    var self = this
        , defer = q.defer();
...
CModel.prototype.findOneAsync = function(query) {
    var self = this
        , defer = q.defer();
...
CModel.prototype.updateAsync = function(query, doc) {
    var self = this
        , defer = q.defer();
...
CModel.prototype.updateById = function(id, doc) {
    if (_.isString(id)) {
        ...
        throw new TypeError('CModel.updateById accepts only strings as arguments!');
    }
...
CModel.prototype.deleteAsync = function(query) {
    var self = this
        , defer = q.defer();
...
CModel.prototype.deleteById = function(id) {
    ...
    if (deleted.length === 1) {
        ...
        throw new RuntimeError('Deleted documents with no uniqe id field!');
    }
};
