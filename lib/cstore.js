 ...
 * var store = new cstore.CStore({name: '$apple'}, {
...
CStore.prototype.createSwapfile = function() {
    ...
    if (_.isString(filename)) {
        ...
        this.warn('No valid filename supplied! CStore [%s] is inmemory only...', this.config.getValue('name'));
    }
};
...
CStore.prototype.getModel = function(name) {
    if (_.isString(name)) {
        ...
        throw new TypeError('CStore.getModel accepts only a string as an argument!');
    }
